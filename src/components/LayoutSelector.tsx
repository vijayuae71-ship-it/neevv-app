  ...
  return (
    <div className="p-4 space-y-4 max-w-2xl mx-auto relative">
      ...
      {layouts.map((layout) => (
        <div
          key={layout.id}
          className="card bg-gray-100 hover:bg-gray-200 transition-colors cursor-pointer"
          ...
          <div className="card-body p-4 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="bg-gray-200 rounded-lg p-2 text-center">
                <Maximize size={14} className="mx-auto opacity-80 mb-1" />
                <div className="text-sm font-bold">{layout.builtUpAreaSqFt}</div>
                <div className="text-[10px] text-gray-500">Sq.Ft Built-up</div>
              </div>

              {/* Vastu Score */}
              {vastuEnabled && (
                <div className="bg-gray-200 rounded-lg p-2 text-center">
                  <Compass size={14} className="mx-auto opacity-80 mb-1" />
                  <div
              ...
              <div className="bg-gray-200 rounded-lg p-2 text-center">
                {layout.nbcCompliant ? (
                  ...
                  <AlertTriangle size={14} className="mx-auto text-amber-600 mb-1" />
                )}
                <div className={`text-sm font-bold ${layout.nbcCompliant ? 'text-green-600' : 'text-amber-600'}`}>
            ...
            <div className="flex flex-wrap gap-1">
              {layout.floors.map((fl) => (
                <span key={fl.floor} className="badge badge-sm bg-gray-200 text-gray-700">
